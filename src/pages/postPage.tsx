    ...
    return (
        <div className="flex justify-center">
            <div>
                ...
                <div>
                    <div className="block max-w-7xl p-6 bg-slate-100 rounded-lg shadow-lg">
                         <div>
                            <div className="flex">
                                <div>
                            ...
                            <input 
                                ...
                                id="default-input" 
                                placeholder="Title" 
                                className="bg-slate-300 border text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pl-8 xl:w-96 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            />
                            <br/>
                            <input 
                                type="text" 
                                id="default-input" 
                                placeholder="Title" 
                                className="bg-slate-300 border h-96 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pl-8 xl:w-96 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            />
